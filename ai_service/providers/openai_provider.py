...
Toutes les interactions avec OpenAI passent exclusivement par ce module.
Les services métier n'importent jamais openai directement — uniquement call_llm_json.

Garanties :
- Réponse JSON stricte (response_format json_object)
- Timeout configurable
- Retries automatiques via le client OpenAI
